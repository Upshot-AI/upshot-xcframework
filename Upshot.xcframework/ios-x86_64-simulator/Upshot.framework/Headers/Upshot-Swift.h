...
SWIFT_CLASS("_TtC6Upshot22InboxControllerManager")
@interface InboxControllerManager : NSObject
- (void)getUnreadNotificationsCountWithNotificationType:(BKInboxMessageType)notificationType appuid:(NSString * _Nonnull)appuid fromLastDays:(NSInteger)fromLastDays onCompletion:(void (^ _Nonnull)(NSInteger))onCompletion;
- (void)showInboxControllerWithOptions:(NSDictionary<NSString *, id> * _Nonnull)options appuid:(NSString * _Nonnull)appuid;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface InteractiveTutorialController (SWIFT_EXTENSION(Upshot))
- (void)viewWillTransitionToSize:(CGSize)size withTransitionCoordinator:(id <UIViewControllerTransitionCoordinator> _Nonnull)coordinator;
@end
...
SWIFT_CLASS("_TtC6Upshot19NotificationHandler")
@interface NotificationHandler : NSObject
- (void)fetchUsernotificationsWithAppuid:(NSString * _Nonnull)appuid notificationId:(NSString * _Nonnull)notificationId limit:(NSInteger)limit fromLastDays:(NSInteger)fromLastDays completionBlock:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSString * _Nullable))completionBlock;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC6Upshot24PushAmplificationHandler")
@interface PushAmplificationHandler : NSObject
- (void)updatePushReadStatusWithMsgId:(NSString * _Nonnull)msgId appuid:(NSString * _Nonnull)appuid onCompletion:(void (^ _Nullable)(BOOL, NSString * _Nonnull))onCompletion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)getImageDataWithUrl:(NSURL * _Nonnull)url completion:(void (^ _Nonnull)(NSData * _Nonnull))completion;
@end
