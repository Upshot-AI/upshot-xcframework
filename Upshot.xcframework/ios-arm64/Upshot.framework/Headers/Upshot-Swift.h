...
- (void)getUnreadNotificationsCountWithPushLimit:(NSInteger)pushLimit notificationType:(BKInboxMessageType)notificationType appuid:(NSString * _Nonnull)appuid onCompletion:(void (^ _Nonnull)(NSInteger))onCompletion;
