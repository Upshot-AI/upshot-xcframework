...
- (void)getUnreadNotificationsCountWithNotificationType:(BKInboxMessageType)notificationType appuid:(NSString * _Nonnull)appuid onCompletion:(void (^ _Nonnull)(NSInteger))onCompletion;
...
- (void)fetchUsernotificationsWithAppuid:(NSString * _Nonnull)appuid notificationId:(NSString * _Nonnull)notificationId limit:(NSInteger)limit completionBlock:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSString * _Nullable))completionBlock;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
